...
//////////////////////////////////////////*/
var slideIn = 'Global';
$('.top-slider_btn_left').click(function(){
	slideIn = 'toRight';
	$('.slide:not(.active)>.aaa>.top-slide_img_item').css('right','20%');
});
$('.top-slider_btn_right').click(function(){
	slideIn = 'toLeft';
	$('.slide:not(.active)>.aaa>.top-slide_img_item').css('right','-20%');
});
;(function($){
	$.fn.wipeSlider = function(options){
		  ...
		  this.each(function(index){
			  ...
			  var toRight = function(){
				  slideIn = 'toRight';
				  $('.active>.aaa>.top-slide_img_item').css('right','20%')
				  slideW = 100;
  ...
  $('.js_wiper').wipeSlider({
	  ...
	  slideBefore : 	function(){
		  if(slideIn === 'toLeft'){
			...
			$('.active>.aaa>.top-slide_img_item').delay(600).fadeIn(800).animate(
			{
			  right: '0%',
				},{
				duration: 1200,
