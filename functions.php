...
function my_child_styles() {
  ...
  wp_enqueue_style( 'swiper', get_stylesheet_directory_uri() . '/lib/css/swiper.css', array(), '1.0.3' );
  wp_enqueue_style( 'wipeSlider', get_stylesheet_directory_uri() . '/lib/css/wipeSlider.css', array(), '1.0.3' );
  }
...
wp_enqueue_script( 'easing', get_stylesheet_directory_uri() . '/lib/js/easing.js', array( 'jquery' ), '1.0.2', true );
wp_enqueue_script( 'jquery.bxslider', get_stylesheet_directory_uri() . '/lib/js/jquery.bxslider.js', array( 'jquery' ), '1.0.2', true );
wp_enqueue_script( 'swiper', get_stylesheet_directory_uri() . '/lib/js/swiper.js', array( 'jquery' ), '1.0.2', true );
wp_enqueue_script( 'jquery.wipeSlider', get_stylesheet_directory_uri() . '/lib/js/jquery.wipeSlider.js', array( 'jquery' ), '1.0.2', true );
}
